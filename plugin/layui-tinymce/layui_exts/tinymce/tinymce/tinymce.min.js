...
!function () {
    ...
    var e, n, f, d = function (t) {
        ...
        }, q = y("string"), _ = y("object"), S = y("array"), w = C(null), x = b("boolean"), R = C(undefined),
        T = function (e) {
            return !(null === (t = e) || t === undefined);
            var t
        }, A = b("function"), D = b("number"), O = Array.prototype.slice, B = Array.prototype.indexOf,
        P = Array.prototype.push, L = function (e, t) {
            return B.call(e, t)
        }, I = function (e, t) {
            return -1 < L(e, t)
        }, M = function (e, t) {
    ...
    var Ne, Ee, ke, _e, Re, Te, Ae, De = function (e, t) {
        ...
        }, je = ze(/^\s+|\s+$/g), He = ze(/^\s+/g), Ve = ze(/\s+$/g), qe = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        $e = function (t) {
            return function (e) {
                return Fe(e, t)
            }
            ...
            name: "Chrome", versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, qe], search: function (e) {
            ...
            name: "Safari", versionRegexes: [qe, /.*?cpu os ([0-9]+)_([0-9]+).*/], search: function (e) {
        ...
        }], Xe = {browsers: N(We), oses: N(Ke)}, Ye = "Firefox", Ge = function (e) {
            ...
            firefox: N(Ye),
            safari: N("Safari")
        }, Qe = "Windows", Ze = "Android", et = "Solaris", tt = "FreeBSD", nt = "ChromeOS", rt = function (e) {
            var t = e.current, n = e.version, r = function (e) {
                return function () {
                    return t === e
                }
            ...
            var n, r, o, i, a, u, s, c, l, f, d, m, p = Xe.browsers(), g = Xe.oses(), h = Ie(p, e).fold(Je.unknown, Je.nu),
        ...
        ht = -1 !== ct.indexOf("Windows Phone"), vt = {
            ...
            trim: bt, isArray: pe, is: Ct, toArray: function (e) {
                if (pe(e)) return e;
            ...
            fromHtml: function (e, t) {
                ...
                return St(n)
            }, fromDom: St, fromPoint: function (e, t, n) {
        ...
        }, Pt = Bt(1), Lt = Bt(3), It = Bt(9), Mt = Bt(11), Ft = function (e) {
            ...
            return Mt(e)
        }, Jt = A(Element.prototype.attachShadow) && A(Node.prototype.getRootNode), Qt = N(Jt), Zt = Jt ? function (e) {
            ...
            var t, n, r = e === undefined ? window : e, o = r.document, i = vn(Nt.fromDom(o));
        ...
        }, Dn = En(["textarea", "input"]), On = xn(3), Bn = xn(8), Pn = xn(9), Ln = xn(11), In = En(["br"]),
        Mn = En(["img"]), Fn = An("true"), Un = An("false"), zn = En(["td", "th"]),
        jn = En(["video", "audio", "object", "embed"]), Hn = function (e) {
            ...
            var n = e.dom, r = Gn(n, t);
            return U.from(r).filter(function (e) {
                return 0 < e.length
            })
        }, Qn = function (e) {
            var t = {}, n = e.dom;
            if (Hn(n)) for (var r = 0; r < n.style.length; r++) {
                var o = n.style.item(r);
                t[o] = n.style[o]
            }
            return t
        }, Zn = st().browser, er = function (e) {
            return K(e, Pt)
        }, tr = function (e, t) {
    ...
    _e = undefined, Re = rr, Te = or, Ae = undefined, function (e) {
    ...
    var ir = or.exports.boltExport, ar = function (e) {
            ...
            return {
                is: function (e) {
                    return n === e
                }, isValue: k, isError: p, getOr: N(n), getOrThunk: N(n), getOrDie: N(n), or: function (e) {
                    return dr(n)
                }, orThunk: function (e) {
                    return dr(n)
                }, fold: function (e, t) {
            ...
            return {
                is: p, isValue: p, isError: k, getOr: o, getOrThunk: function (e) {
                    return e()
                }, getOrDie: function () {
                    return m(String(n))()
                }, or: function (e) {
                    ...
                    return mr(n)
                }, exists: p, forall: k, toOptional: U.none
            }
        }, pr = {
            value: dr, error: mr, fromOption: function (e, t) {
        ...
        hr = (gr([{bothErrors: ["error1", "error2"]}, {firstError: ["error1", "value2"]}, {secondError: ["value1", "error2"]}, {bothValues: ["value1", "value2"]}]), function (e) {
            return e.fold(o, o)
        });
    ...
    var Lr = function (e, t) {
        ...
        requestAnimationFrame: function (e, t) {
        ...
        }, setTimeout: Lr, setInterval: Ir, setEditorTimeout: function (e, t, n) {
            return Lr(function () {
                e.removed || t()
            }, n)
            ...
            return r
        }, debounce: Mr, throttle: Mr, clearInterval: function (e) {
    ...
    function Ur(m, p) {
        void 0 === p && (p = {});
        var g = 0, h = {}, v = Nt.fromDom(m), y = Ut(v), b = p.maxLoadTime || 5e3, n = function (e, t, n) {
            var r, o = xt._addCacheSuffix(e), i = de(h, o).getOrThunk(function () {
    ...
    var qr, $r, Wr = function (t) {
        ...
        Qr = Wr(["ul", "ol", "dl"]), Zr = Wr(["li", "dd", "dt"]), eo = Wr(["thead", "tbody", "tfoot"]),
        to = Wr(["td", "th"]), no = Wr(["pre", "script", "textarea", "style"]), ro = "\ufeff", oo = "\xa0", io = ro,
        ao = function (e) {
            return e === ro
        }, uo = function (e) {
            return e.replace(/\uFEFF/g, "")
        }, so = Nn, co = On, lo = function (e) {
            ...
            var t, n
        }, wo = Fn, xo = Un, So = In, No = On, Eo = En(["script", "style", "textarea"]),
        ko = En(["img", "input", "textarea", "hr", "iframe", "video", "audio", "object", "embed"]), _o = En(["table"]),
        Ro = mo, To = function (e) {
            ...
            var n, r, o, i = Nt.fromDom(t), a = Nt.fromDom(e);
            ...
            var n, r, o
        }, Io = _n("data-mce-bookmark"), Mo = _n("data-mce-bogus"), Fo = (qr = "data-mce-bogus", $r = "all", function (e) {
        ...
        ei = function (e, t) {
            ...
            encodeRaw: ei, encodeAllRaw: function (e) {
                return ("" + e).replace(Ko, function (e) {
                    return Go[e] || e
                })
            }, encodeNumeric: ti, encodeNamed: ni, getEncodeFunc: function (e, t) {
                var n = Qo(t) || Zo, r = qo(e.replace(/\+/g, ","));
        ...
        }, oi = {}, ii = {}, ai = xt.makeMap, ui = xt.each, si = xt.extend, ci = xt.explode, li = xt.inArray,
        fi = function (e, t) {
            ...
            var s, t, n, r, o, i, c = {}, a = function (e, t, n) {
                ...
                for (var a = fi(e), u = a.length; u--;) o = {
                    attributes: i(r = fi([s, t].join(" "))),
                    attributesOrder: r,
                    children: i(n, ii)
                }, c[a[u]] = o
            }, u = function (e, t) {
    ...
    function pi(i) {
        ...
        var r = mi(i.valid_styles), o = mi(i.invalid_styles, "map"), a = mi(i.valid_classes, "map"),
        ...
        var E = function (e) {
            ...
            if (e) {
                ...
                for (S["@"] && (h = S["@"].attributes, v = S["@"].attributesOrder), t = 0, n = x.length; t < n; t++) if (i = b.exec(x[t])) {
                    if (p = i[1], c = i[2], g = i[3], s = i[5], a = {
                        ...
                        d[t] = e
                    }), m.push.apply(m, v)), s) for (r = 0, o = (s = fi(s, "|")).length; r < o; r++) if (i = C.exec(s[r])) {
                        ...
                        p && ("=" === p && (a.attributesDefault = a.attributesDefault || [], a.attributesDefault.push({
                            ...
                            name: l,
                            value: y
                        }), u.forcedValue = y), "<" === p && (u.validValues = ai(y, "?"))), w.test(l) ? (a.attributePatterns = a.attributePatterns || [], u.pattern = E(l), a.attributePatterns.push(u)) : (d[l] || m.push(l), d[l] = u)
                    }
                    h || "@" !== c || (h = d, v = m), g && (a.outputName = c, S[g] = a), w.test(c) ? (a.pattern = E(c), N.push(a)) : S[c] = a
                }
            }
        }, C = function (e) {
            S = {}, N = [], b(e), ui(n, function (e, t) {
                u[t] = e.children
            })
        }, w = function (e) {
            var a = /^(~)?(.+)$/;
            e && (oi.text_block_elements = oi.block_elements = null, ui(fi(e, ","), function (e) {
                ...
                u[i] = u[o], s[i] = o, r || (v[i.toUpperCase()] = {}, v[i] = {}), S[i] || (t = S[o], delete(t = si({}, t)).removeEmptyAttrs, delete t.removeEmpty, S[i] = t), ui(u, function (e, t) {
            ...
            oi[i.schema] = null, e && ui(fi(e, ","), function (e) {
                var t, n, r = o.exec(e);
                r && (n = r[1], t = n ? u[r[2]] : u[r[2]] = {"#comment": {}}, t = u[r[2]], ui(fi(r[3], "|"), function (e) {
                    "-" === n ? delete t[e] : t[e] = {}
                }))
            })
        }, k = function (e) {
        ...
        })), w(i.custom_elements), x(i.valid_children), b(i.extended_valid_elements), x("+ol[ul|ol],+ul[ul|ol]"), ui({
            dd: "dl",
            dt: "dl",
            li: "ul ol",
            td: "tr",
    ...
    var gi = function (e, t, n, r) {
        ...
        if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
            ...
            }), (i = l.events[o][a]) ? "ready" === a && l.domLoaded ? n(Si({type: a})) : i.push({
                func: n,
                scope: r
            }) : (l.events[o][a] = i = [{
                func: n,
    ...
    var ki, _i, Ri, Ti, Ai, Di, Oi, Bi, Pi, Li, Ii, Mi, Fi, Ui, zi, ji, Hi, Vi = "sizzle" + -new Date,
        qi = window.document, $i = 0, Wi = 0, Ki = Ea(), Xi = Ea(), Yi = Ea(), Gi = function (e, t) {
            return e === t && (Li = !0), 0
        }, Ji = typeof undefined, Qi = {}.hasOwnProperty, Zi = [], ea = Zi.pop, ta = Zi.push, na = Zi.push, ra = Zi.slice,
        ...
        la = new RegExp("^" + ia + "*," + ia + "*"), fa = new RegExp("^" + ia + "*([>+~]|" + ia + ")" + ia + "*"),
        da = new RegExp("=" + ia + "*([^\\]'\"]*?)" + ia + "*\\]", "g"), ma = new RegExp(sa),
        pa = new RegExp("^" + aa + "$"), ga = {
            ID: new RegExp("^#(" + aa + ")"),
            CLASS: new RegExp("^\\.(" + aa + ")"),
            TAG: new RegExp("^(" + aa + "|[*])"),
        ...
        }, ha = /^(?:input|select|textarea|button)$/i, va = /^h\d$/i, ya = /^[^{]+\{\s*\[native \w/,
        ba = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Ca = /[+~]/, wa = /'|\\/g,
        xa = new RegExp("\\\\([\\da-f]{1,6}" + ia + "?|(" + ia + ")|.)", "ig"), Sa = function (e, t, n) {
            var r = "0x" + t - 65536;
    ...
    function Oa(a, e, t) {
        var u = e.dir, s = t && "parentNode" === u, c = Wi++;
    ...
    function La(m, p, g, h, v, e) {
        return h && !h[Vi] && (h = La(h)), v && !v[Vi] && (v = La(v, e)), ka(function (e, t, n, r) {
            var o, i, a, u = [], s = [], c = t.length, l = e || function (e, t, n) {
                    ...
                    return n
                }(p || "*", n.nodeType ? [n] : n, []), f = !m || !e && p ? l : Pa(l, u, m, n, r),
                d = g ? v || (e ? m : c || h) ? [] : t : f;
    ...
    ki = Na.support = {}, Ti = Na.isXML = function (e) {
        ...
        var t, s = e ? e.ownerDocument || e : qi, n = s.defaultView;
                ...
                return 1 === p && 0 === g ? function (e) {
                    ...
                    if (l) {
                        ...
                        if (s = [v ? l.firstChild : l.lastChild], v && d) {
                            for (u = (r = (o = l[Vi] || (l[Vi] = {}))[m] || [])[0] === $i && r[1], a = r[0] === $i && r[2], i = u && l.childNodes[u]; i = ++u && i && i[c] || (a = u = 0) || s.pop();) if (1 === i.nodeType && ++a && i === e) {
                                o[m] = [$i, u, a];
                                break
                            }
                        } else if (d && (r = (e[Vi] || (e[Vi] = {}))[m]) && r[0] === $i) a = r[1]; else for (; (i = ++u && i && i[c] || (a = u = 0) || s.pop()) && ((y ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[Vi] || (i[Vi] = {}))[m] = [$i, a]), i !== e));) ;
        ...
        pseudos: {
            not: ka(function (e) {
                ...
                return t = t.replace(xa, Sa), function (e) {
                    return -1 < (e.textContent || e.innerText || Ri(e)).indexOf(t)
                }
            }), lang: ka(function (n) {
                return pa.test(n || "") || Na.error("unsupported lang: " + n), n = n.replace(xa, Sa).toLowerCase(), function (e) {
                    var t;
                    do {
        ...
        if (!a) {
            for (n = (t = t || Ai(e)).length; n--;) (a = function f(e) {
                ...
                }]; u < o; u++) if (t = _i.relative[e[u].type]) l = [Oa(Ba(l), t)]; else {
            ...
            (a = Yi(e, (h = i, y = 0 < (v = o).length, b = 0 < h.length, r = function (e, t, n, r, o) {
                var i, a, u, s = 0, c = "0", l = e && [], f = [], d = Bi, m = e || b && _i.find.TAG("*", o),
                    p = $i += null == d ? 1 : Math.random() || .1, g = m.length;
        ...
        var o, i, a, u, s, c = "function" == typeof e && e, l = !r && Ai(e = c.selector || e);
        if (n = n || [], 1 === l.length) {
            ...
            for (o = ga.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o], !_i.relative[u = a.type]);) if ((s = _i.find[u]) && (r = s(a.matches[0].replace(xa, Sa), Ca.test(i[0].type) && Ta(t.parentNode) || t))) {
    ...
    var Ia = document, Ma = Array.prototype.push, Fa = Array.prototype.slice,
        Ua = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, za = Ni.Event, ja = xt.makeMap("children,contents,next,prev"),
        Ha = function (e) {
            return void 0 !== e
        }, Va = function (e) {
            return "string" == typeof e
        }, qa = function (e, t) {
            var n, r = (t = t || Ia).createElement("div"), o = t.createDocumentFragment();
            for (r.innerHTML = e; n = r.firstChild;) o.appendChild(n);
            return o
        }, $a = function (e, t, n, r) {
            var o;
            if (Va(t)) t = qa(t, iu(e[0])); else if (t.length && !t.nodeType) {
                if (t = lu.makeArray(t), r) for (o = t.length - 1; 0 <= o; o--) $a(e, t[o], n, r); else for (o = 0; o < t.length; o++) $a(e, t[o], n, r);
                return e
            }
        ...
        Ga = {"for": "htmlFor", "class": "className", readonly: "readOnly"}, Ja = {"float": "cssFloat"}, Qa = {},
        Za = {}, eu = function (e, t) {
            return new lu.fn.init(e, t)
        }, tu = /^\s*|\s*$/g, nu = function (e) {
    ...
    eu.fn = eu.prototype = {
        constructor: eu, selector: "", context: null, length: 0, init: function (e, t) {
            var n, r, o = this;
            if (!e) return o;
            ...
            if (Va(e)) {
                ...
                if (n[1]) for (r = qa(e, iu(t)).firstChild; r;) Ma.call(o, r), r = r.nextSibling; else {
            ...
            if (!1 !== t) for (n = lu.unique(this.toArray().concat(lu.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++) this[r] = n[r]; else Ma.apply(this, lu.makeArray(e));
            return this
        }, attr: function (t, n) {
            var e, r = this;
            ...
            if ("object" == typeof n) ru(n, function (e, t) {
                ...
                var e = this.style;
                if ((o = Za[n]) && o.set) o.set(this, r); else {
                    try {
                        this.style[Ja[n] || n] = r
                    } catch (t) {
                    }
        ...
        }, push: Ma, sort: Array.prototype.sort, splice: Array.prototype.splice
    }, xt.extend(eu, {
        extend: xt.extend,
    ...
    var au = function (e, t, n) {
        ...
        var o = [];
        for (r instanceof lu && (r = r[0]); e; e = e[t]) if (!n || e.nodeType === n) {
            if (r !== undefined) {
                if (e === r) break;
    ...
    var cu, lu = eu, fu = xt.each, du = xt.grep, mu = vt.ie, pu = /^([a-z0-9],?)+$/i, gu = function (n, r, o) {
    ...
    function yu(a, u) {
        ...
        var r = {}, c = window, n = {}, t = 0,
            ...
            l = [], f = u.schema ? u.schema : pi({}),
            i = hi({url_converter: u.url_converter, url_converter_scope: u.url_converter_scope}, u.schema),
            d = u.ownEvents ? new Ni : Ni.Event, m = f.getBlockElements(), p = lu.overrideDefaults(function () {
            ...
            }, e = ri.decode, O = ri.encodeAllRaw, B = function (e, t) {
                var n = h(e);
                ...
                isEmpty: function (e, t) {
                    ...
                    if (I(e)) return !1;
                    if (e = e.firstChild) {
                        var i = new Hr(e, e.parentNode), a = f ? f.getWhiteSpaceElements() : {};
    ...
    var bu = yu, Cu = bu.DOM, wu = xt.each, xu = xt.grep, Su = (Nu.prototype._setReferrerPolicy = function (e) {
        this.settings.referrerPolicy = e
    }, Nu.prototype.loadScript = function (e, t, n) {
        var r = Cu, o = r.uniqueId(), i = document.createElement("script");
    ...
    var Eu, ku = function (e) {
        ...
        getData: function () {
            ...
            var t, n, r = Tu().getOr({}), o = function (e) {
    ...
    var Ou, Bu = Du, Pu = function (n, r) {
            ...
            var n, r, o
        }, $u = N("mce-annotation"), Wu = N("data-mce-annotation"), Ku = N("data-mce-annotation-uid"),
        Xu = function (r, e) {
            var t = r.selection.getRng(), n = Nt.fromDom(t.startContainer), o = Nt.fromDom(r.getBody()),
                i = e.fold(function () {
                    return "." + $u()
                }, function (e) {
                    return "[" + Wu() + '="' + e + '"]'
                }), a = Kt(n, t.startOffset).getOr(n), u = kr(a, i, function (e) {
                    return Rt(e, o)
                }), s = function (e, t) {
            ...
            var a = ku({}), c = function (e, t) {
                u(e, function (e) {
                    return t(e), e
                })
            }, u = function (e, t) {
                var n = a.get(), r = t(n.hasOwnProperty(e) ? n[e] : {listeners: [], previous: ku(U.none())});
                n[e] = r, a.set(n)
            }, t = Lu(function () {
            ...
            var n, r, o = Ft(e).dom, i = Nt.fromDom(o.createDocumentFragment()),
        ...
        }, ys = Nn, bs = To, Cs = kn("display", "block table"), ws = kn("float", "left right"), xs = function () {
            for (var n = [], e = 0; e < arguments.length; e++) n[e] = arguments[e];
            return function (e) {
                for (var t = 0; t < n.length; t++) if (!n[t](e)) return !1;
                return !0
            }
        }(ys, bs, d(ws)), Ss = d(kn("white-space", "pre pre-line pre-wrap")), Ns = On, Es = In, ks = bu.nodeIndex, _s = gs,
        Rs = function (e) {
            ...
            return !As(e) && Es(e) && Os(n) ? function (e) {
                var t = e.ownerDocument, n = Rs(t), r = t.createTextNode(oo), o = e.parentNode;
    ...
    function Is(t, n, e) {
        ...
        return {
            container: N(t), offset: N(n), toRange: function () {
    ...
    var Ms, Fs, Us = Is, zs = function (e, t) {
        ...
        }, Hs = On, Vs = Rn, qs = bu.nodeIndex, $s = function (e) {
            var t = e.parentNode;
            return Vs(t) ? $s(t) : t
        }, Ws = function (e) {
            ...
            if (!t) return null;
            var n = t.split(","), r = n[0].split("/"), o = 1 < n.length ? n[1] : "before", i = be(r, function (e, t) {
                var n, r, o, i, a = /([\w\-\(\)]+)\[([0-9]+)\]/.exec(t);
                return a ? ("text()" === a[1] && (a[1] = "#text"), n = e, r = a[1], o = parseInt(a[2], 10), i = Ws(n), i = ve(i, function (e, t) {
            ...
            var r, o
        }, uc = E(rc, o, !0), sc = bu.DOM, cc = function (e, t, n) {
        ...
        }, Bc = st().browser, Pc = Un, Lc = jn, Ic = zn, Mc = function (e, t, n) {
            ...
            var n, u, s = ku(U.none()), r = fc(e), c = 0 < r.length ? r : "p", l = function () {
                !function (e) {
            ...
            return {
                show: function (t, e) {
                    ...
                    if (!a(e)) return u = function (e, t) {
                        var n, r = e.ownerDocument.createTextNode(io), o = e.parentNode;
                        if (t) {
            ...
            return zc(e) || Tn(e) && Uc()
        }, Hc = Un, Vc = jn, qc = kn("display", "block table table-cell table-caption list-item"), $c = mo, Wc = lo,
        Kc = Nn, Xc = To, Yc = function (e, t) {
            for (var n; n = e(t);) if (!Wc(n)) return n;
            return null
        }, Gc = function (e, t, n, r, o) {
            var i = new Hr(e, r), a = Hc(e) || Wc(e);
            if (t < 0) {
            ...
            return null
        }, nl = E(el, !0), rl = E(el, !1), ol = function (e, t, n) {
            var r, o, i = E(tl, !0, t), a = E(tl, !1, t), u = n.startContainer, s = n.startOffset;
            if (lo(u)) {
    ...
    var ll, fl = Un, dl = On, ml = Nn, pl = In, gl = To, hl = function (e) {
        return ko(e) || !!Ao(t = e) && !0 !== W(te(t.getElementsByTagName("*")), function (e, t) {
            return e || wo(t)
        }, !1);
        var t
    }, vl = Do, yl = function (e, t) {
    ...
    }, Al = E(kl, !0), Dl = E(kl, !1), Ol = E(Tl, !0), Bl = E(Tl, !1), Pl = "_mce_caret", Ll = function (e) {
        return Nn(e) && e.id === Pl
    }, Il = function (e, t) {
        for (; t && t !== e;) {
            if (t.id === Pl) return t;
        ...
        if ((n.startContainer !== n.endContainer || !(a = n.startContainer.childNodes[n.startOffset]) || !/^(IMG)$/.test(a.nodeName)) && 1 === s.nodeType) for (u < (i = s.childNodes).length ? (s = i[u], r = new Hr(s, e.getParent(s, e.isBlock))) : (s = i[i.length - 1], (r = new Hr(s, e.getParent(s, e.isBlock))).next(!0)), o = r.current(); o; o = r.next()) if (3 === o.nodeType && !ef(o)) return n.setStart(o, 0), void t.setRng(n)
    }, Jl = function (e, t, n) {
        if (e) {
    ...
    }, cf = $l, lf = uf, ff = ef, df = Ql, mf = function (e, t) {
        for (var n = t; n;) {
        ...
        if (e[0].wrapper || (i = a.getParent(n, e[0].block, u)), i || (o = a.getParent(n, "LI,TD,TH"), i = a.getParent(On(n) ? n.parentNode : n, function (e) {
            return e !== u && df(t, e)
        }, o)), i && e[0].wrapper && (i = lf(a, i, "ul,ol").reverse()[0] || i), !i) for (i = n; i[r] && !a.isBlock(i[r]) && (i = i[r], !nf(i, "br"));) ;
        return i || n
    }, Cf = function (e, t, n, r, o, i, a) {
        var u, s, c, l = u = a ? n : o, f = a ? "previousSibling" : "nextSibling", d = e.getRoot();
        ...
        return as((a = (i = e).startContainer, u = i.startOffset, On(a) ? 0 === u ? U.some(Nt.fromDom(a)) : U.none() : U.from(a.childNodes[u]).map(Nt.fromDom)), (n = (t = e).endContainer, r = t.endOffset, On(n) ? r === n.data.length ? U.some(Nt.fromDom(n)) : U.none() : U.from(n.childNodes[r - 1]).map(Nt.fromDom)), function (e, t) {
            var n = K(Rf(o), E(Rt, e)), r = K(Tf(o), E(Rt, t));
            return n.isSome() && r.isSome()
        }).getOr(!1);
        var t, n, r, i, a, u
    }, Df = function (e, t, n, r) {
        var o = n, i = new Hr(n, o), a = le(e.schema.getMoveCaretBeforeOnEnterElements(), function (e, t) {
    ...
    var Lf, If, Mf, Ff = (Lf = Lt, If = "text", {
        ...
        var a = [], u = jf(i.getDoc(), r, t, n), s = ku(U.none()), c = function () {
            s.set(U.none())
        }, l = function (e) {
            $(e, o)
        }, o = function (e) {
        ...
        u.undoManager.transact(function () {
            var e, t, n, r, o = u.selection, i = o.getRng(), a = 0 < _f(u).length;
            i.collapsed && !a && (n = wf(e = u, t = i, [{inline: !0}]), t.setStart(n.startContainer, n.startOffset), t.setEnd(n.endContainer, n.endOffset), e.selection.setRng(t)), o.getRng().collapsed && !a ? (r = jf(u.getDoc(), l, s, c.decorate), es(r, oo), o.getRng().insertNode(r.dom), o.select(r.dom)) : Pf(o, !1, function () {
                Bf(u, function (e) {
        ...
        return {
            register: function (e, t) {
                ...
                var t, n, r, o, i,
                    a = (t = u, n = e, r = Nt.fromDom(t.getBody()), o = qu(r, "[" + Wu() + '="' + n + '"]'), i = {}, $(o, function (e) {
                        var t = Wn(e, Ku()), n = i.hasOwnProperty(t) ? i[t] : [];
                        i[t] = n.concat([e])
                    }), i);
    ...
    var Wf, Kf = $f, Xf = function (e, t) {
    ...
    }, Jf = Un, Qf = function (r, l) {
        var f, d, m, p, g, h, v, y, b, C, w, x, S, N, E = l.dom, s = xt.each, c = l.getDoc(), k = document,
            _ = Math.abs, R = Math.round, T = l.getBody(),
            A = {nw: [0, 0, -1, -1], ne: [1, 0, 1, -1], se: [1, 1, 1, 1], sw: [0, 1, -1, 1]}, D = function (e) {
                ...
                M(), F();
                var t = E.getPos(e, T), o = t.x, i = t.y, n = e.getBoundingClientRect(), a = n.width || n.right - n.left,
        ...
        var o, i, a, u, s = e.getRoot(), c = !1, l = r[(n ? "start" : "end") + "Container"],
            f = r[(n ? "start" : "end") + "Offset"], d = Nn(l) && f === l.childNodes.length,
    ...
    var dd, md, pd, gd, hd, vd = (dd = "height", md = function (e) {
            ...
            set: function (e, t) {
                ...
                return t
            }, getOuter: pd, aggregate: gd = function (o, e) {
                return W(e, function (e, t) {
                    var n = Yn(o, t), r = n === undefined ? 0 : parseInt(n, 10);
            ...
            var t, n, r, o = Nt.fromDom(document), i = vn(o), a = (t = e, r = (n = bd).owner(t), yd(n, r)), u = hn(e),
                s = H(a, function (e, t) {
                    var n = hn(t);
            ...
            var n, r = function (e) {
                ...
                var i = gn(null == r ? void 0 : r.pageYOffset, o.scrollTop),
                    a = gn(null == r ? void 0 : r.pageXOffset, o.scrollLeft), u = gn(o.clientTop, n.clientTop),
            ...
            var n = function (e, t) {
                ...
                var r = n[n.length - 1];
                return wd(r) ? {element: e, offset: t} : "img" === Dt(r) ? {element: r, offset: 1} : Lt(r) ? {
                    element: r,
                    offset: Uf(r).length
                } : {element: r, offset: Wt(r).length}
            }(e, t), r = Nt.fromHtml('<span data-mce-bogus="all">\ufeff</span>');
            ...
            var o = e.dom.defaultView.innerHeight;
            Ad(e, t, o, n, r);
            var i = Cd(n.element), a = wn(window);
        ...
        qd = {
            domRange: Vd.domRange, relative: Vd.relative, exact: Vd.exact, exactFromRange: function (e) {
    ...
    var _m = xt.makeMap, Rm = function (e) {
        var u = [], s = (e = e || {}).indent, c = _m(e.indent_before || ""), l = _m(e.indent_after || ""),
            f = ri.getEncodeFunc(e.entity_encoding || "raw", e.entities), d = "html" === e.element_format;
        return {
        ...
        var X = W.comment ? W.comment : e, Y = W.cdata ? W.cdata : e, G = W.text ? W.text : e,
            ...
            n = function (m, e) {
                ...
                for (var t, n, r, p, o, i, a, g, u, s, c, l, f, h, v, d, y, b, C, w = m.html, x = 0, S = [], N = 0, E = ri.decode, k = xt.makeMap("src,href,data,background,formaction,poster,xlink:href"), _ = /((java|vb)script|mhtml):/i, R = "html" === e ? 0 : 1, T = function (e) {
                    ...
                    var q = t[0];
                    if (x < t.index && A(E(w.substr(x, t.index - x))), n = t[7]) ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), T(n); else if (n = t[8]) {
    ...
    (Om = Om || {}).findEndTag = Dm;
    var Bm, Pm, Lm = Om, Im = function (e, t) {
            ...
            return uo(c)
        }, Mm = Im, Fm = function (e, t, n, r) {
            var o, i, a, u, s;
            if (t.format = n, t.get = !0, t.getInner = !0, t.no_events || e.fire("BeforeGetContent", t), "raw" === t.format) o = xt.trim(Mm(e.serializer, r.innerHTML)); else if ("text" === t.format) o = uo(r.innerText || r.textContent); else {
        ...
        }, Hm = E(jm, !0, Kl), Vm = E(jm, !1, Kl), qm = function (e) {
            var t = e.container();
            ...
            var t
        }, Xm = $m(!0, Wm), Ym = $m(!1, Wm), Gm = $m(!0, jn), Jm = $m(!1, jn), Qm = $m(!0, Tn), Zm = $m(!1, Tn),
        ep = $m(!0, Km), tp = $m(!1, Km), np = function (e) {
            var t = qu(e, "br"), n = j(function (e) {
        ...
        }, dp = E(fp, !1), mp = E(fp, !0), pp = E(lp, !1), gp = E(lp, !0), hp = function (e) {
            return ul(e).exists(Gr)
        }, vp = function (e, t, n) {
            var r = j(up(Nt.fromDom(n.container()), t), Xr), o = Z(r).getOr(t);
            ...
            var n
        }, Cp = E(vp, !1), wp = E(vp, !0), xp = function (e) {
            ...
            var n, t = e.data, r = (n = t.split(""), F(n, function (e, t) {
            ...
            var n = e.data.slice(t), r = n.length - He(n).length;
            return Ip(e, t, r)
        }, Fp = function (e, t) {
            var n = e.data.slice(0, t), r = n.length - Ve(n).length;
            return Ip(e, t - r, r)
        }, Up = function (e, t, n, r) {
            void 0 === r && (r = !0);
            ...
            var n, r, o, i, u = Ht(e).filter(Lt), s = Vt(e).filter(Lt);
            ...
            void 0 === r && (r = !0);
            var o, i, a = $p(n, t.getBody(), e.dom), u = xr(e, E(Kp, t), (o = t.getBody(), function (e) {
                return e.dom === o
        ...
        Zp = function (e, t) {
            ...
            var t = Zp(e.startContainer, r), n = Zp(e.endContainer, r);
            ...
            t.deleteContents();
            var r, o, i = fg(n).getOr(n), a = Nt.fromDom(e.dom.getParent(i.dom, e.dom.isBlock));
            ...
            var n, r, o, i, a, u = Nt.fromDom(e.selection.getStart(!0)), s = _f(e);
            ...
            var u = Us.fromRangeStart(a), s = Us.fromRangeEnd(a), c = a.commonAncestorContainer;
            ...
            var n = Us.after(e), r = wl(t).prev(n);
            ...
            var n, r, a, u, s, c, l, f, d, m, p, g, h, v, y, b, C, w, x, S,
                ...
                E = Ag(o, i.startContainer), k = Tg((f = N.firstChild, xt.grep(f.childNodes, function (e) {
                    return "LI" === e.nodeName
                }))), _ = o.getRoot(), R = function (e) {
                    var t = Us.fromRangeStart(i), n = wl(o.getRoot()), r = 1 === e ? n.prev(t) : n.next(t);
            ...
            var t = e.dom, n = Eg(e.selection.getRng());
            ...
            var p = e.parser, g = n.merge, h = Tm({validate: e.getParam("validate")}, e.schema),
            ...
            if ((y = e.fire("BeforeSetContent", y)).isDefaultPrevented()) e.fire("SetContent", {
                ...
                var S, N, E, k, _, R, T, A, D, O, B, P, L, I,
            ...
            e.dom.setHTML(e.getBody(), t), pm(r = e) && Ol(r.getBody()).each(function (e) {
                var t = e.getNode(), n = Tn(t) ? Ol(t).getOr(e) : e;
            ...
            return c.format = c.format ? c.format : "html", c.set = !0, c.content = Ug(s) ? "" : s, Ug(s) || c.no_events || (u.fire("BeforeSetContent", c), s = c.content), U.from(u.getBody()).fold(N(s), function (e) {
                ...
                }(u, e, s, c) : (t = u, n = e, o = c, 0 === (r = s).length || /^\s+$/.test(r) ? (a = '<br data-mce-bogus="1">', "TABLE" === n.nodeName ? r = "<tr><td>" + a + "</td></tr>" : /^(UL|OL)$/.test(n.nodeName) && (r = "<li>" + a + "</li>"), r = (i = fc(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase()) ? (r = a, t.dom.createHTML(i, dc(t), r)) : r || '<br data-mce-bogus="1">', zg(t, r), t.fire("SetContent", o)) : ("raw" !== o.format && (r = Tm({validate: t.validate}, t.schema).serialize(t.parser.parse(r, {
                    isRootContent: !0,
                    insert: !0
                }))), o.content = no(Nt.fromDom(n)) ? r : xt.trim(r), zg(t, o.content), o.no_events || t.fire("SetContent", o)), o.content);
                var t, n, r, o, i, a
            })
        }, Hg = nf, Vg = function (e, t, n) {
            ...
            if (c && t) for (a = 0; a < c.length; a++) if (i = c[a], $g(e.dom, t, i) && Wg(l, t, i, "attributes", o, r) && Wg(l, t, i, "styles", o, r)) {
            ...
            if (u) for (n = e.selection.getStart(), r = uf(s, n), i = u.length - 1; 0 <= i; i--) {
        ...
        }, Qg = io, Zg = "_mce_caret", eh = function (e) {
            return 0 < function (e) {
                for (var t = []; e;) {
            ...
            if (t) rh(e, t, n); else if (!(t = Il(e.getBody(), o.getStart()))) for (; t = r.get(Zg);) rh(e, t, !1)
        }, ih = function (e, t) {
            ...
            i && (o ? (a = y.getBookmark(), C.collapse(!0), u = wf(e, C, e.formatter.get(t), !0), u = cd(u), e.formatter.remove(t, n, u, r), y.moveToBookmark(a)) : (s = Il(e.getBody(), i), c = nh(!1).dom, m = c, p = null !== s ? s : i, g = (d = e).dom, (h = g.getParent(p, E(Ql, d))) && g.isEmpty(h) ? p.parentNode.replaceChild(m, p) : (np(Nt.fromDom(p)), g.isEmpty(p) ? p.parentNode.replaceChild(m, p) : g.insertAfter(m, p)), l = function (t, e, n, r, o, i) {
                var a = t.formatter, u = t.dom, s = j(ne(a.get()), function (e) {
    ...
    Pm = function (e) {
        var t, n = e.selection.getRng(), r = En(["pre"]);
    ...
    var mh = xt.each, ph = function (e) {
        ...
        }, wh = gr([{keep: []}, {rename: ["name"]}, {removed: []}]), xh = /^(src|href|style)$/, Sh = xt.each, Nh = nf,
        Eh = function (e, t, n) {
            ...
            var i = Nt.fromDom(t), a = Nt.fromDom(e.create(r, o)), u = (n ? $t : qt)(i);
            ...
            var t, d = s.formatter.get(c), m = d[0], i = !0, a = s.dom, n = s.selection, u = function (e) {
                var n, t, r, o, i, a,
                    u = (t = e, r = c, o = l, i = f, $(uf((n = s).dom, t.parentNode).reverse(), function (e) {
                        var t;
                ...
                if (m.split) {
                    if (r = cd(r), (t = kh(s, r, !0)) !== (n = kh(s, r))) {
                        ...
                        t = Rh(a, t, "span", {id: "_start", "data-mce-type": "bookmark"}), n = Rh(a, n, "span", {
                            id: "_end",
            ...
            if (e) Yl(e) ? ((t = a.createRng()).setStartBefore(e), t.setEndAfter(e), r(t)) : r(e); else if ("false" !== a.getContentEditable(n.getNode())) n.isCollapsed() && m.inline && !_f(s).length ? uh(s, c, l, f) : (Pf(n, !0, function () {
                Bf(s, r)
            }), m.inline && Xg(s, c, l, n.getStart()) && Gl(a, n, n.getRng()), s.nodeChanged()); else {
                e = n.getNode();
                for (var o = 0; o < d.length && (!d[o].ceFalseOverride || !Oh(s, d[o], l, e, e)); o++) ;
            }
        }, Lh = xt.each, Ih = function (i, e, a, u) {
            Lh(e, function (t) {
                var r, e, n, o;
        ...
        }, Mh = xt.each, Fh = function (E, k, _, r) {
            var e, t, n, R = E.formatter.get(k), T = R[0], o = !r && E.selection.isCollapsed(), i = E.dom, a = E.selection,
                A = function (n, e) {
                    var t;
                    ...
                    var N = [], l = !0, f = T.inline || T.block, d = S.create(f);
                    A(d), Sf(S, e, function (e) {
                        var u, s = function (e) {
                            ...
                            if (T.wrapper && Kg(E, e, k, _)) u = 0; else {
            ...
            for (var n = e.rows, r = 0; r < n.length; r++) for (var o = n[r].cells, i = 0; i < o.length; i++) if (Rt(o[i], t)) return U.some({
                x: i,
                y: r
            });
            return U.none()
            ...
            return K(t, function (e) {
                ...
                return K(t, function (e) {
                    ...
                    var t = Nt.fromTag(Dt(e)), n = le(Qn(e), function (e, t) {
            ...
            var n, r = Nt.fromDom(t.commonAncestorContainer), o = up(r, e), i = j(o, function (e) {
                return Yr(e) || Kr(e)
            }), a = Yh(o, t), u = i.concat(a.length ? a : Zr(n = r) ? jt(n).filter(Qr).fold(N([]), function (e) {
                return [n, e]
            }) : Qr(n) ? [n] : []);
            return F(u, ns)
        }, Jh = function () {
            ...
            return t = e, n = o[0], Nr(n, "table", E(Rt, t)).bind(function (e) {
                var t = o[0], n = o[o.length - 1], r = Wh(e);
            ...
            if ("text" === n.format) return l = e, U.from(l.selection.getRng()).map(function (e) {
                ...
                }, e.cloneContents()), n = nv(t), r = uo(t.textContent);
                if (l.dom.remove(t), tv(r, 0) || tv(r, r.length - 1)) {
                    var o = l.dom.getParent(e.commonAncestorContainer, l.dom.isBlock), i = nv(o), a = i.indexOf(n);
            ...
            n.getInner = !0;
            var r, o, i, a, u, s, c, l,
                f = (o = n, i = (r = e).selection.getRng(), a = r.dom.create("body"), u = r.selection.getSel(), s = wm(r, Nf(u)), (c = o.contextual ? ev(Nt.fromDom(r.getBody()), s).dom : i.cloneContents()) && a.appendChild(c), r.selection.serializer.serialize(a, o));
            ...
            return {
                undoManager: {
                    ...
                    getContent: function (e, t) {
                        ...
                        var n = a.getContent(), r = Tm({inner: !0});
                    ...
                    getContent: function (e, t) {
                        ...
                        var n = a.getSelectedContent(), r = Tm({});
            ...
            i.no_events || !(i = e.fire("BeforeSetContent", i)).isDefaultPrevented() ? (n.content = function (e, t) {
                ...
                var n = U.from(t.firstChild).map(Nt.fromDom), r = U.from(t.lastChild).map(Nt.fromDom);
                e.deleteContents(), e.insertNode(t);
                var o = n.bind(Ht).filter(Lt).bind(kv), i = r.bind(Vt).filter(Lt).bind(kv);
    ...
    var Av = function (e) {
        ...
        var l, f, i, n, a, d, r = function (e, t) {
            ...
            getSelectedBlocks: function (e, t) {
                return function (e, t, n, r) {
                    var o, i = [], a = e.getRoot();
                    if (n = e.getParent(n || ym(a, t, t.collapsed), e.isBlock), r = e.getParent(r || bm(a, t, t.collapsed), e.isBlock), n && n !== a && i.push(n), n && r && n !== r) for (var u = new Hr(o = n, a); (o = u.next()) && o !== r;) e.isBlock(o) && i.push(o);
        ...
        0 !== o.src.indexOf("blob:") ? (n = (e = Lv(o.src)).data, a = e.type, u = n, (s = r.getByData(u, a)) ? i({
            ...
            t(e)
        })) : (s = r.getByUri(o.src)) ? i({image: o, blobInfo: s}) : Mv(o.src).then(function (t) {
            var n;
    ...
    var Hv, Vv, qv = function (e, t, n, r) {
        ...
        }, Yv = xt.makeMap, Gv = xt.each, Jv = xt.explode, Qv = xt.extend, Zv = function (R, T) {
            void 0 === T && (T = pi());
            var A = {}, D = [], O = {}, B = {};
            ...
            var e, t, P = function (e) {
                ...
                schema: T, addAttributeFilter: function (e, n) {
                    ...
                    var f, d = Qv(Yv("script,style,head,html,body,title,meta,param"), T.getBlockElements()),
                        m = T.getNonEmptyElements(), p = T.children, g = R.validate,
                        h = "forced_root_block" in u ? u.forced_root_block : R.forced_root_block,
                        v = !1 === (f = h) ? "" : !0 === f ? "p" : f, y = T.getWhiteSpaceElements(), b = /^[ \t\r\n]+/,
                        C = /[ \t\r\n]+$/, w = /[ \t\r\n]+/g, x = /^[ \t\r\n]+$/,
                        S = y.hasOwnProperty(u.context) || y.hasOwnProperty(R.root_name), N = function (e, t) {
                            var n, r = new Em(e, t);
                        ...
                        }, T), _ = c = new Em(u.context || R.root_name, 11);
                    if (k.parse(e, u.format), g && l.length && (u.context ? u.invalid = !0 : function (e) {
                        for (var t, n, r, o, i, a, u, s, c, l, f = Yv("tr,td,th,tbody,thead,tfoot,table"), d = T.getNonEmptyElements(), m = T.getWhiteSpaceElements(), p = T.getTextBlockElements(), g = T.getSpecialElements(), h = 0; h < e.length; h++) if ((t = e[h]).parent && !t.fixed) if (p[t.name] && "li" === t.parent.name) {
            ...
            var e = ["data-mce-selected"], C = b && b.dom ? b.dom : bu.DOM, w = b && b.schema ? b.schema : pi(y);
            ...
            return {
                ...
                serialize: function (e, t) {
                    void 0 === t && (t = {});
                    var n, r, o, i, a, u, s, c, l, f, d, m, p = xe({format: "html"}, t), g = ey(b, e, p),
                        h = (n = C, r = g, i = uo((o = p).getInner ? r.innerHTML : n.getOuterHTML(r)), o.selection || no(Nt.fromDom(r)) ? i : xt.trim(i)),
                        v = (a = x, u = h, d = (s = p).selection ? xe({forced_root_block: !1}, s) : s, m = a.parse(u, d), l = function (e) {
                            return e && "br" === e.name
        ...
        }, fy = Object.prototype.hasOwnProperty, dy = (Hv = function (e, t) {
            ...
            return n
        }), my = st().deviceType, py = my.isTouch(), gy = my.isPhone(), hy = my.isTablet(),
        vy = ["lists", "autolink", "autosave"], yy = {table_grid: !1, object_resizing: !1, resize: !1},
        by = function (e) {
            var t = S(e) ? e.join(" ") : e, n = F(q(t) ? t.split(" ") : [], je);
            ...
            var o, i, a, u, s, c, l, f = by(n.forced_plugins), d = by(r.plugins),
                m = wy(o = t, i = "mobile") ? o.sections()[i] : {}, p = m.plugins ? by(m.plugins) : d,
        ...
        }, Dy = E(Ty, "clientWidth"), Oy = E(Ty, "clientHeight"), By = E(Ay, "margin-top"), Py = E(Ay, "margin-left"),
        Ly = function (e, t, n) {
    ...
    var Fy = Bu.PluginManager, Uy = Bu.ThemeManager;
    var zy = function (n) {
        var r = [], o = function () {
            var e, t = n.theme;
            ...
            var e;
            e = t, n.fire("CloseWindow", {dialog: e}), 0 === (r = j(r, function (e) {
                return e !== t
            })).length && n.focus()
        }, s = function (e) {
    ...
    var Yy = 0, Gy = function (e) {
        ...
        var n, o, e, t, r, i, a, u, c, l = (n = [], o = function (e) {
            ...
            var t = e.id || Gy("blobid"), n = e.name || t;
            return {
                id: N(t),
                name: N(n),
                filename: N(n + "." + ({
        ...
        return s.on("SetContent", function () {
            ...
            blobCache: l, addFilter: function (e) {
                d.push(e)
            }, uploadImages: b, uploadImagesAuto: C, scanForImages: x, destroy: function () {
                l.destroy(), f.destroy(), i = r = null
            }
        }
    }, Qy = function (r, e, t, n) {
        var o = ne(t.get()), i = {}, a = {}, u = j(uf(r.dom, e), function (e) {
    ...
    var nb, rb, ob = xt.each, ib = bu.DOM, ab = function (e, t) {
            var n, o, r, m = t && t.schema || pi({}), p = function (e) {
            ...
            var c,
                l = (c = e.selector) && "string" == typeof c ? (c = (c = c.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1"), xt.map(c.split(/(?:>|\s+(?![^\[\]]+\]))/), function (e) {
                    var t = xt.map(e.split(/(?:~\+|~|\+)/), ub), n = t.pop();
                    return t.length && (n.siblings = t), n
                }).reverse()) : [], f = l.length ? (l[0].name || (l[0].name = t), t = e.selector, ab(l, n)) : ab([t], n),
            ...
            var e, c = ku(U.none()), l = ku(0), f = ku(0), d = {
        ...
        mb = "data-mce-placeholder", pb = function (e) {
        ...
        }, xb = E(wb, !0), Sb = E(wb, !1), Nb = function (e, t) {
            ...
            var n = Nt.fromDom(e), r = Nt.fromDom(t.container());
            return Nb(n, r).map(function (e) {
                return {block: e, position: t}
            })
        }, Rb = function (o, i, e) {
            var t = _b(o, Us.fromRangeStart(e)), n = t.bind(function (e) {
            ...
            var n = Nt.fromDom(t), r = E(Rt, e);
            return xr(n, to, r).isSome()
        }, Ub = function (e, t) {
            var n, r, o = Dl(e.dom, Us.fromRangeStart(t)).isNone(), i = Al(e.dom, Us.fromRangeEnd(t)).isNone();
            return !(Fb(n = e, (r = t).startContainer) || Fb(n, r.endContainer)) && o && i
        }, zb = function (e) {
            var n, r, o, t, i = Nt.fromDom(e.getBody()), a = e.selection.getRng();
        ...
        }, Hb = Fn, Vb = Un, qb = function (e, t, n, r, o) {
            ...
            var r = ol(1, e.getBody(), t), o = Us.fromRangeStart(r), i = o.getNode();
            ...
            var r = t ? Ms.Forwards : Ms.Backwards, o = wl(e.getBody()), i = E(sl, t ? o.next : o.prev), a = t ? Xb : Yb,
                u = al(r, e.getBody(), n), s = wb(t, i(u));
        ...
        Zb = function (e, t, n, r) {
            ...
            var t, n = e.dom, r = e.selection, o = Xf(e.getBody(), r.getNode());
        ...
        }, mC = E(dC, !0), pC = E(dC, !1), gC = function (e, t) {
        ...
        CC = function (e, t) {
            ...
            var n = t.selection.getRng(), r = e ? Us.fromRangeEnd(n) : Us.fromRangeStart(n);
        ...
        }, WC = E(qC, !0), KC = E(qC, !1), XC = function (t, n) {
            return function (e) {
            ...
            var e, t, a = (e = n.getBody(), t = o.container(), Jc(t, e) || e), u = E(yb, n), s = RC(u, a, o);
            ...
            var o, i, a, u, s, c = E(ch, t), l = F(j(r, c), function (e) {
                return e.dom
            });
            ...
            var t, e = Nt.fromDom(r.getBody()), n = Nt.fromDom(r.selection.getStart()),
            ...
            return ee(s).exists(function (e) {
                ...
                return i = o, a = n, u = e.dom, !(!as(Ol(u), Bl(u), function (e, t) {
                    var n = wb(!0, e), r = wb(!1, t), o = wb(!1, a);
            ...
            return !e.mode.isReadOnly() && (1 < t.length || (r = e, G(t, function (e) {
                var t = iw(vc(r), e), n = Jn(e, t).map(ow).getOr(0);
            ...
            if (e.selection.isCollapsed() && aw(e)) {
                var n = e.dom, r = e.selection.getRng(), o = Us.fromRangeStart(r),
            ...
            var u = ku(U.none()), s = ku(!1), r = Lu(function (e) {
            ...
            if (s && Nn(s) && l) {
                ...
                if (a.isValidChild(f, l.toLowerCase()) && (d = u, m = c, p = s, !M(ap(Nt.fromDom(p), Nt.fromDom(m)), function (e) {
                    ...
                    for (var d, m, p, g, h, v = i.getRng(), y = v.startContainer, b = v.startOffset, C = v.endContainer, w = v.endOffset, x = pm(e), s = c.firstChild; s;) if (g = u, On(h = s) || Nn(h) && !gw(g, h) && !$l(h)) {
                        if (function (e, t) {
                            if (On(t)) {
    ...
    }, kw = E(xw, Is.isAbove, -1), _w = E(xw, Is.isBelow, 1), Rw = E(Sw, -1, kw), Tw = E(Sw, 1, _w), Aw = function (t) {
        var e = function (e) {
            return F(e, function (e) {
    ...
    var Ow = function (o, i, a, e, u, t) {
    ...
    }, Bw = E(Ow, bw.Up, fs, ds), Pw = E(Ow, bw.Down, ds, fs), Lw = function (n) {
        return function (e) {
            return t = n, e.line > t;
            var t
        }
        ...
        return be(e, function (e, t) {
            var n = Math.min(Uw(e, o), zw(e, o)), r = Math.min(Uw(t, o), zw(t, o));
        ...
        var r, o, i = Dw(j(te(e.getElementsByTagName("*")), jc)), a = j(i, E(Hw, n));
        if (u = Vw(a, t)) {
        ...
        var a = t === Ms.Forwards, u = wl(e.getBody()), s = E(sl, a ? u.next : u.prev), c = a ? r : o;
        if (!n.collapsed) {
            var l = ps(n);
        ...
        var d = wb(a, s(f)), m = lo(n.startContainer);
        ...
        var a = al(e, t.getBody(), n), u = we(a.getClientRects()), s = e === bw.Down;
        if (!u) return U.none();
        var c, l = (s ? Pw : Bw)(t.getBody(), Lw(1), a), f = j(l, Iw(1)), d = u.left, m = Vw(f, d);
        if (m && i(m.node)) {
        ...
        if (c = r(a) ? a.getNode() : o(a) ? a.getNode(!0) : ps(n)) {
            var h = function (e, t, n, r) {
                var o, i, a, u, s = wl(t), c = [], l = 0, f = function (e) {
                ...
                return c
            }(e, t.getBody(), Lw(1), c), v = Vw(j(h, Iw(1)), d);
        ...
        if (t) {
            var o = Us.fromRangeEnd(n), i = _w(r, o);
    ...
    }, Qw = Un, Zw = function (e, t, n) {
        var r, o, i = wl(e.getBody()), a = E(sl, 1 === t ? i.next : i.prev);
        if (n.collapsed && "" !== fc(e)) {
        ...
        var e, r, o = Nt.fromDom(t.getBody()), i = Us.fromRangeStart(t.selection.getRng()), a = fc(t), u = dc(t);
    ...
    }, Ex = E(Nx, kw), kx = E(Nx, _w), _x = function (t, e, n, r) {
        ...
        var o, i, a, u, s, c, l = e.selection.getRng(), f = Us.fromRangeStart(l), d = e.getBody();
        if (!t && Ex(r, f)) {
        ...
        i.on("keydown", function (e) {
            ...
            !1 === e.isDefaultPrevented() && (t = i, n = a, r = e, o = st().os, px([{
                keyCode: Gf.RIGHT,
                action: mx(nx, t, !0)
            }, {keyCode: Gf.LEFT, action: mx(nx, t, !1)}, {keyCode: Gf.UP, action: mx(rx, t, !1)}, {
                keyCode: Gf.DOWN,
                action: mx(rx, t, !0)
            }, {keyCode: Gf.RIGHT, action: mx(Ox, t, !0)}, {keyCode: Gf.LEFT, action: mx(Ox, t, !1)}, {
                keyCode: Gf.UP,
                action: mx(Bx, t, !1)
            }, {keyCode: Gf.DOWN, action: mx(Bx, t, !0)}, {keyCode: Gf.RIGHT, action: mx(gx, t, !0)}, {
                keyCode: Gf.LEFT,
                action: mx(gx, t, !1)
            }, {keyCode: Gf.UP, action: mx(hx, t, !1)}, {keyCode: Gf.DOWN, action: mx(hx, t, !0)}, {
                keyCode: Gf.RIGHT,
                action: mx(VC, t, n, !0)
                ...
                keyCode: Gf.UP,
                action: mx(fx, t, !1)
            }, {keyCode: Gf.DOWN, action: mx(fx, t, !0)}], r).each(function (e) {
                r.preventDefault()
            }))
        })
    }, Lx = function (o, i) {
        o.on("keydown", function (e) {
            ...
            !1 === e.isDefaultPrevented() && (t = o, n = e, px([{
                keyCode: Gf.BACKSPACE,
                action: mx(iC, t)
            }, {keyCode: Gf.DELETE, action: mx(iC, t)}], n))
        })
    }, Ix = function (e, t) {
        ...
        n && n.toLowerCase() === t.tagName.toLowerCase() && function (e, o, t) {
            ...
            U.from(t.style).map(i.parseStyle).each(function (e) {
                var t = Qn(Nt.fromDom(o)), n = xe(xe({}, t), e);
                i.setStyles(o, n)
            });
            ...
            var a = ["style", "class"], u = le(t, function (e, t) {
                return !I(a, t)
            });
            i.setAttribs(o, u)
        }(e, t, dc(e))
        ...
        E && ((N && !y || !N && y) && (u = function (e, t, n, r, o) {
            var i, a, u, s, c, l, f = t || "P", d = e.dom, m = Kx(d, r), p = d.getParent(r, d.isBlock);
            if (!p || !$x(d, p)) {
    ...
    }, uS = gr([{br: []}, {block: []}, {none: []}]), sS = function (e, t) {
        ...
        r.on("keydown", function (e) {
            ...
            !1 === e.isDefaultPrevented() && (t = r, n = e, px([{
                keyCode: Gf.END,
                action: mx(ox, t, !0)
            }, {keyCode: Gf.HOME, action: mx(ox, t, !1)}, {keyCode: Gf.END, action: mx(vx, t, !0)}, {
                keyCode: Gf.HOME,
                action: mx(vx, t, !1)
            }], n).each(function (e) {
                n.preventDefault()
    ...
    }, ES = E(NS, oo), kS = E(NS, " "), _S = function (r, o) {
        return function (e) {
            return t = r, (!kp(n = e) && (_p(t, n) || Np(t, n) || Ep(t, n)) ? ES : kS)(o);
            var t, n
        }
    }, RS = function (e) {
        var t, n, r = Us.fromRangeStart(e.selection.getRng()), o = Nt.fromDom(e.getBody());
        if (e.selection.isCollapsed()) {
            var i = E(yb, e), a = Us.fromRangeStart(e.selection.getRng());
    ...
    var BS = function (e) {
        ...
        }), i = bu.DOM, a = document, u = jS(o, e), s = HS(o, e), c = VS(o, e), l = (n = o, function () {
            n.on(function (e) {
        ...
        $S(e), (n = e).on("drop", function (e) {
            ...
            var t = bu.DOM, n = i.dom, r = document, o = i.inline ? i.getBody() : i.getDoc(), e = ["drop", "dragover"];
            $(e, function (e) {
        ...
        var s, c = u.selection, l = u.dom, f = l.isBlock, d = u.getBody(), m = Fc(u, d, f, function () {
            ...
            var r = function (e, t, n) {
                var r = u.$, o = Er(Nt.fromDom(u.getBody()), "#" + p).fold(function () {
                    return r([])
                }, function (e) {
                    return r([e.dom])
                });
        ...
        return vt.ceFalse && function () {
            ...
            var a = function (e) {
                ...
                var n, r = Us.before(e.firstChild), o = t.next(r);
        ...
        var s, n, r, o = xt.each, c = Gf.BACKSPACE, l = Gf.DELETE, f = u.dom, d = u.selection, e = u.parser,
            t = vt.gecko, i = vt.ie, a = vt.webkit, m = "data:text/mce-internal,", p = i ? "Text" : "URL",
            g = function (e, t) {
                try {
        ...
        u.inline || Of(u) && u.selection.getStart(!0) !== e || Ol(e).each(function (e) {
            var t, n, r, o, i = e.getNode(), a = Tn(i) ? Ol(i).getOr(e) : e;
    ...
    }, sN = bu.DOM, cN = function (t, n, e) {
        var r = Fy.get(e), o = Fy.urls[e] || t.documentBaseUrl.replace(/\/$/, "");
        ...
        var n, r = yN(o, "default", t), i = (n = o, U.from(n.getParam("icons_url", "", "string")).filter(function (e) {
            return 0 < e.length
        }).map(function (e) {
        ...
        n = s, o = t, i = function () {
            ...
            vN(s, e), bN(s, e, t), r = e, o = t, xt.each(r.getParam("external_plugins"), function (e, t) {
                ...
                (e = xt.trim(e)) && !Fy.urls[e] && (hN(e) ? (e = e.substr(1, e.length), t = Fy.dependencies(e), xt.each(t, function (e) {
                    var t = {prefix: "plugins/", resource: e, suffix: "/plugin" + o + ".js"}, n = Fy.createUrl(t, e);
    ...
    }, NN = {"font-size": "size", "font-family": "face"}, EN = function (e, t, n) {
        var r = function (r) {
    ...
    }, _N = kN("font-size"), RN = a(function (e) {
        return e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")
    }, kN("font-family")), TN = function (e) {
    ...
    }, PN = xt.each, LN = xt.map, IN = xt.inArray, MN = (FN.prototype.execCommand = function (t, n, r, e) {
        var o, i, a = !1, u = this;
        if (!u.editor.removed) {
        ...
        a.addCommands({
            ...
            return AN(t = i, function (n) {
                ...
                return SN(n, function (e) {
                    ...
                    var e = parseFloat(Yn(n, "line-height")), t = parseFloat(Yn(n, "font-size"));
                    return String(e / t)
                })
            }).getOr("");
            var t
    ...
    var UN = "data-mce-contenteditable", zN = function (e, t, n) {
            var r, o;
    ...
    var YN, GN = function (n) {
    ...
    }), rE = ["design", "readonly"], oE = function (e, t, n, r) {
        ...
        f11: 122,
        f12: 123
    }, cE = xt.makeMap("alt,ctrl,shift,meta,access"), lE = (fE.prototype.add = function (e, n, t, r) {
        ...
        return o[o.length - 1] = xt.extend(o[o.length - 1], {
            func: n,
            scope: r || this.editor
        }), xt.extend(o[0], {desc: this.editor.translate(t), subpatterns: o.slice(1)})
    ...
    var bE = bu.DOM, CE = xt.extend, wE = xt.each, xE = xt.resolve, SE = vt.ie,
    ...
    function EE(e, t, n) {
        ...
        var o = iE(this);
        this.mode = o, this.setMode = o.set, n.fire("SetupEditor", {editor: this}), this.execCallback("setup", this), this.$ = lu.overrideDefaults(function () {
            return {context: r.inline ? r.getBody() : r.getDoc(), element: r.getBody()}
        })
    }

    var kE, _E = bu.DOM, RE = xt.explode, TE = xt.each, AE = xt.extend, DE = 0, OE = !1, BE = [], PE = [],
        LE = function (t) {
            var n = t.type;
        ...
        }, FE = "CSS1Compat" !== document.compatMode, UE = xe(xe({}, JN), {
            baseURI: null,
            baseURL: null,
            defaultSettings: {},
            ...
            init: function (r) {
                var n, u = this,
                    ...
                    c = function (e) {
                        ...
                        _E.unbind(window, "ready", e), function (e) {
                            var t = r[e];
            ...
            add: function (e) {
                var n = this;
                return BE[e.id] === e || (null === n.get(e.id) && ("length" !== e.id && (BE[e.id] = e), BE.push(e), PE.push(e)), IE(!0), n.activeEditor = e, n.fire("AddEditor", {editor: e}), kE || (kE = function (e) {
    ...
    UE.setup();
    var zE, jE, HE, VE, qE = Math.min, $E = Math.max, WE = Math.round, KE = function (e, t, n) {
        ...
        }, relativePosition: KE, findBestRelativePosition: function (e, t, n, r) {
            for (var o, i = 0; i < r.length; i++) if ((o = KE(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y) return r[i];
            return null
        }, intersect: function (e, t) {
            var n = $E(e.x, t.x), r = $E(e.y, t.y), o = qE(e.x + e.w, t.x + t.w), i = qE(e.y + e.h, t.y + t.h);
            return o - n < 0 || i - r < 0 ? null : XE(n, r, o - n, i - r)
        }, clamp: function (e, t, n) {
            var r = e.x, o = e.y, i = e.x + e.w, a = e.y + e.h, u = t.x + t.w, s = t.y + t.h, c = $E(0, t.x - r),
                l = $E(0, t.y - o), f = $E(0, i - u), d = $E(0, a - s);
            return r += c, o += l, n && (i += c, a += l, r -= f, o -= d), XE(r, o, (i -= f) - r, (a -= d) - o)
        }, create: XE, fromClientRect: function (e) {
    ...
    }), JE = xt.each, QE = xt.extend, ZE = function () {
    };
    ...
    var ek = Math.min, tk = Math.max, nk = Math.round, rk = {
        serialize: function (e) {
        ...
        callbacks: {}, count: 0, send: function (t) {
            var n = this, r = bu.DOM, o = t.count !== undefined ? t.count : n.count, i = "tinymce_jsonp_" + o;
        ...
        send: function (e) {
            ...
            if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = !1 !== e.async, e.data = e.data || "", ik.fire("beforeInitialize", {settings: e}), (t = new XMLHttpRequest).overrideMimeType && t.overrideMimeType(e.content_type), t.open(e.type || (e.data ? "POST" : "GET"), e.url, e.async), e.crossDomain && (t.withCredentials = !0), e.content_type && t.setRequestHeader("Content-Type", e.content_type), e.requestheaders && xt.each(e.requestheaders, function (e) {
    ...
    }), ak = xt.extend, uk = (sk.sendRPC = function (e) {
        return (new sk).send(e)
    }, sk.prototype.send = function (e) {
        var n = e.error, r = e.success, o = ak(this.settings, e);
    ...
    fk = mk, window.tinymce = fk, window.tinyMCE = fk, function (e) {
